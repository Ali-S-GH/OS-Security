...
<div><figure><img src="../../.gitbook/assets/image (5).png" alt="New password with 7 charachers instead of 8"><figcaption><p><mark style="color:$danger;"><strong>New password with 7 charachers instead of 8</strong></mark></p></figcaption></figure> <figure><img src="../../.gitbook/assets/image (6).png" alt=""><figcaption></figcaption></figure></div>
...
5. Go back to permissions Select the user ⇒ Type: Deny \
